...
class Window(QMainWindow):
    ...
    def examplaryUI(self):
        ...
        self.splitter1.splitterMoved.connect(
            lambda: self.splitter2.setSizes(self.splitter1.sizes()))
        self.splitter2.splitterMoved.connect(
            lambda: self.splitter1.setSizes(self.splitter2.sizes()))
